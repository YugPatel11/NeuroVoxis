  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-white selection:bg-purple-500/30 selection:text-purple-200 font-sans overflow-x-hidden">
      ...
      <nav className="relative z-50 flex items-center justify-between px-6 py-6 max-w-7xl mx-auto">
        ...
        <button className="px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-sm font-semibold hover:bg-white/10 transition-all active:scale-95 backdrop-blur-sm">
          Get Started
        </button>
      </nav>
      ...
      <main className="relative z-10 px-6 pt-20 pb-32 max-w-7xl mx-auto text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="group relative px-8 py-4 rounded-full bg-purple-600 font-bold hover:bg-purple-500 transition-all hover:shadow-[0_0_40px_rgba(147,51,234,0.3)] flex items-center gap-2 overflow-hidden">
